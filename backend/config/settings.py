...
# Backend base URL — used to build the email-verification link
# (the browser clicks it → Django verifies → redirects to FRONTEND_URL/login?verified=true)
...
UNFOLD = {
    "SITE_TITLE": "Kenya Airways",
    "SITE_HEADER": "Kenya Airways Admin",
